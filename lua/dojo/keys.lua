    ...
    sections = {
      {
        items = {
          ...
          { mac = "⌘J", keys = { "<C-`>", "<D-j>" }, mode = { "n", "i", "t" }, run = A.toggle_terminal, desc = "Show / hide the terminal", vim = "Ctrl-/" },
          { mac = "⌘R", keys = { "<D-r>", "<F5>" }, mode = NIV, run = A.run_file, desc = "Save & run this file", vim = "Space r r", tip = "Python, JS/TS, Lua, shell, Go, Rust. q closes the output." },
